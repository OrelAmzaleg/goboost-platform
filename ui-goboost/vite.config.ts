...
// GoBoost fork note: imports moved from '../shared/...' (pixel-agents monorepo
// layout) to './shared/...' since we lifted shared/ into ui-goboost itself.
...
function browserMockAssetsPlugin(): Plugin {
  ...
  // GoBoost: build output stays inside ui-goboost (was '../dist/webview' in upstream).
...
export default defineConfig({
  ...
  // GoBoost: build into local dist/ (was '../dist/webview' in the VS Code extension layout).
  build: {
    outDir: 'dist',
    emptyOutDir: true,
  },
